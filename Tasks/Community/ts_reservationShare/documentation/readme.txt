...
Description: Python reference example triggered automation task for the "On Reservation Created" event
Category: task
Class: Community

When a reservation is created, it is automatically shared with the "user group admin" defined in the script itself, allowing one or more team member to manage the reservation on behalf of the user.
