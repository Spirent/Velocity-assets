...
Description: Python reference example triggered automation task for the "On Request Approved" event  
Category: task  
Class: Community  
  
When a reservation request is accepted, this event fires to parse the reservation request details and opens a task issue in Jira with the user's request.  
